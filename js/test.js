...
var TraceryNode_1 = require("./TraceryNode");
var Symbol_1 = require("./Symbol");
var Grammar = /** @class */ (function () {
    function Grammar(tracery, raw) {
    ...
    Grammar.prototype.clearState = function () {
        for (var name_1 in this.symbols) {
            this.symbols[name_1].clearState();
        }
    };
        ...
        if (this.raw) {
            ...
            for (var key in this.raw) {
                if (this.raw.hasOwnProperty(key)) {
                    this.symbols[key] = new Symbol_1.Symbol(this.tracery, this, key, this.raw[key]);
                }
            }
        }
    };
    Grammar.prototype.createRoot = function (rule) {
        ...
        var root = new TraceryNode_1.TraceryNode(this.tracery, this, 0, {
            type: -1,
            raw: rule,
        });
        return root;
    ...
    Grammar.prototype.expand = function (rule, allowEscapeChars) {
        if (allowEscapeChars === void 0) { allowEscapeChars = false; }
    ...
    Grammar.prototype.pushRules = function (key, rawRules, sourceAction) {
        if (this.symbols[key] === undefined) {
            this.symbols[key] = new Symbol_1.Symbol(this.tracery, this, key, rawRules);
            if (sourceAction)
...
},{"./Symbol":5,"./TraceryNode":7}],5:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var RuleSet_1 = require("./RuleSet");
var Symbol = /** @class */ (function () {
    function Symbol(tracery, grammar, key, rawRules) {
        this.tracery = tracery;
        ...
        this.uses = [];
        this.baseRules = new RuleSet_1.RuleSet(tracery, grammar, rawRules);
        this.clearState();
    }
    ...
    Symbol.prototype.pushRules = function (rawRules) {
        var rules = new RuleSet_1.RuleSet(this.tracery, this.grammar, rawRules);
...
},{"./RuleSet":4}],7:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var Grammar_1 = require("./Grammar");
var Tracery_1 = require("./Tracery");
var NodeAction_1 = require("./NodeAction");
var TraceryNode = /** @class */ (function () {
    function TraceryNode(tracery, parent, childIndex, settings) {
        this.tracery = tracery;
        ...
        if (parent instanceof Grammar_1.Grammar) {
            this.grammar = parent;
            this.parent = null;
            this.depth = 0;
            this.childIndex = 0;
    ...
    TraceryNode.prototype.expandChildren = function (childRule, preventRecursion) {
        ...
        var parseResult = this.tracery.parse(childRule);
        // Add errors to this
    ...
    TraceryNode.prototype.expand = function (preventRecursion) {
        ...
        if (!this.isExpanded) {
            ...
            switch (this.type) {
                // Raw rule
                case Tracery_1.Type.Raw:
                    this.expandChildren(this.raw, preventRecursion);
                    break;
                // plaintext, do nothing but copy text into finsihed text
                case Tracery_1.Type.Main:
                    this.finishedText = this.raw;
                    break;
                // Tag
                case Tracery_1.Type.OpenSquare:
                    // Parse to find any actions, and figure out what the symbol is
                    this.preactions = [];
                    this.postactions = [];
                    var parsed = this.tracery.parseTag(this.raw);
                    if (parsed == null)
                        return;
                    ...
                    for (var i_1 = 0; i_1 < parsed.preactions.length; i_1++) {
                        this.preactions[i_1] = new NodeAction_1.NodeAction(this.tracery, this, parsed.preactions[i_1].raw);
                    }
                    for (var i_2 = 0; i_2 < parsed.postactions.length; i_2++) {
                        //   this.postactions[i] = new NodeAction(this, parsed.postactions[i].raw);
                    }
                    // Make undo actions for all preactions (pops for each push)
                    for (var i_3 = 0; i_3 < this.preactions.length; i_3++) {
                        if (this.preactions[i_3].type === 0) {
                            var undoAction = this.preactions[i_3].createUndo();
                            if (undoAction !== null)
                                this.postactions.push(undoAction);
                        }
                    }
                    // Activate all the preactions
                    for (var i_4 = 0; i_4 < this.preactions.length; i_4++) {
                        this.preactions[i_4].activate();
                    }
                    this.finishedText = this.raw;
                    ...
                    for (var i_5 = 0; i_5 < this.modifiers.length; i_5++) {
                        var modName = this.modifiers[i_5];
                        var modParams = [];
                        if (modName.indexOf("(") > 0) {
                            var regExp = /\(([^)]+)\)/;
                            // Todo: ignore any escaped commas.  For now, commas always split
                            var results = regExp.exec(this.modifiers[i_5]);
                            if (!results || results.length < 2) {
                            }
                            else {
                                modParams = results[1].split(",");
                                modName = this.modifiers[i_5].substring(0, modName.indexOf("("));
                            }
                        }
                    ...
                    break;
                case Tracery_1.Type.CloseSquare:
                    // Just a bare action?  Expand it!
                    this.action = new NodeAction_1.NodeAction(this.tracery, this, this.raw);
...
exports.TraceryNode = TraceryNode;
},{"./Grammar":2,"./NodeAction":3,"./Tracery":6}],3:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var TraceryNode_1 = require("./TraceryNode");
var NodeActionType;
(function (NodeActionType) {
    /** [key:rule] */
    NodeActionType[NodeActionType["Push"] = 0] = "Push";
    /** [key:POP] */
    NodeActionType[NodeActionType["Pop"] = 1] = "Pop";
    /**
     * [functionName(param0,param1)]
     * //TODO: implement
     */
    NodeActionType[NodeActionType["Function"] = 2] = "Function";
})(NodeActionType = exports.NodeActionType || (exports.NodeActionType = {}));
// An action that occurs when a node is expanded
// Types of actions:
// 0 Push:
// 1 Pop: 
// 2 function: 
var NodeAction = /** @class */ (function () {
    function NodeAction(tracery, node, raw) {
        /*
         if (!node)
        ...
        switch (this.type) {
            case NodeActionType.Push:
                ...
                for (var i = 0; i < this.ruleSections.length; i++) {
                    var n = new TraceryNode_1.TraceryNode(this.tracery, grammar, 0, {
                        type: -1,
...
},{"./TraceryNode":7}],4:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
var RuleSet = /** @class */ (function () {
    function RuleSet(tracery, grammar, raw) {
        this.tracery = tracery;
        this.grammar = grammar;
        this.raw = raw;
        //TODO: Better type
        this.conditionalRule = false;
        this.conditionalValues = {};
        this.defaultRules = [];
        this.falloff = 1;
        this.shuffledDeck = [];
        this.distribution = null;
        this.defaultUses = null;
    ...
    RuleSet.prototype.selectRule = function (errors) {
        ...
        if (this.defaultRules !== undefined) {
            ...
            var distribution = this.distribution || this.grammar.distribution;
            switch (distribution) {
                case Distribution.Shuffle:
                    // create a shuffle desk
                    if (this.shuffledDeck.length === 0) {
                        // make an array
                        this.shuffledDeck = this.tracery.fyshuffle(Util_1.range(this.defaultRules.length)
                        /*, this.falloff*/
                        );
                    }
...
var Tracery = /** @class */ (function () {
     ...
     */
    Tracery.prototype.setRng = function (rng) {
        this.rng = rng;
    };
    Tracery.prototype.random = function () {
        return this.rng();
    };
    Tracery.prototype.createGrammar = function (raw) {
        return new Grammar_1.Grammar(this, raw);
    };
    /**
     * Shuffles an array using the internal randomiser
     */
    Tracery.prototype.fyshuffle = function (array) {
    ...
    Tracery.prototype.parseTag = function (tagContents) {
        var preactions = [];
        //TODO: postactions is always empty
        var postactions = [];
        var modifiers = [];
        var parseResult = this.parse(tagContents);
        var sections = parseResult.sections;
    ...
    Tracery.prototype.parse = function (rule) {
        var depth = 0;
        var inTag = false;
        var sections = [];
        var escaped = false;
    ...
    Tracery.TraceryNode = TraceryNode_1.TraceryNode;
    Tracery.Grammar = Grammar_1.Grammar;
    Tracery.Symbol = Symbol_1.Symbol;
    Tracery.RuleSet = RuleSet_1.RuleSet;
    return Tracery;
}());
exports.Tracery = Tracery;
},{"./Grammar":2,"./RuleSet":4,"./Symbol":5,"./TraceryNode":7}],9:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var Tracery_1 = require("../Tracery");
var mods_eng_basic_1 = require("../tracery/mods-eng-basic");
var $ = require("jquery");
/**
 * @author Kate
 * Test cases
 */
var tracery = new Tracery_1.Tracery();
;
;
function runTests() {
    ...
    grammar.addModifiers(mods_eng_basic_1.baseEngModifiers);
...
runTests();
},{"../Tracery":6,"../tracery/mods-eng-basic":10,"jquery":1}],10:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
/**
 * @author Kate
