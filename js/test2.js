...
},{"./Symbol":5,"./TraceryNode":7}],7:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./Grammar":2,"./NodeAction":3,"./Tracery":6}],5:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./RuleSet":4}],3:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var TraceryNode_1 = require("./TraceryNode");
var NodeActionType;
...
function makeGrammar() {
    ...
    var symbols = keys.map(function (key, index) {
        var rules = ruleGrammar.flatten("#ruleset#", false);
    ...
    for (var i = 0; i < keys.length; i++) {
        var expansions = [];
        for (var j = 0; j < 5; j++) {
            expansions.push(grammar.flatten("#" + keys[i] + "#", false));
        }
